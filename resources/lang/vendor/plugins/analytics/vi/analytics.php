...
return [
    ...
    'credential_is_not_valid' => 'Thông tin cài đặt không hợp lệ. Tài liệu hướng dẫn tại đây: <a href="http://docs.shariqq.com/cms/:version/analytics" target="_blank">http://docs.shariqq.com/cms/:version/analytics</a>',
    ...
    'view_id_not_specified' => 'Bạn phải cung cấp View ID hợp lê. Tài liệu hướng dẫn tại đây: <a href="http://docs.shariqq.com/cms/:version/analytics" target="_blank">http://docs.shariqq.com/cms/:version/analytics</a>',
    'wrong_configuration' => 'Để xem dữ liệu thống kê Google Analytics, bạn cần lấy thông tin Client ID và thêm nó vào trong phần cài đặt. Bạn cũng cần thông tin xác thực dạng JSON. Tài liệu hướng dẫn tại đây: <a href="http://docs.shariqq.com/cms/:version/analytics" target="_blank">http://docs.shariqq.com/cms/:version/analytics</a>',
    'settings' => [
