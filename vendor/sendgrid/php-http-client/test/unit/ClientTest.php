...
class ClientTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->headers = [
            ...
            'Authorization: Bearer SG.botble.'
        ];
    ...
    public function testGetHeaders()
    {
        $client = new Client(
            ...
            ['Content-Type: application/json', 'Authorization: Bearer SG.botble.']
        );
        $this->assertSame(['Content-Type: application/json', 'Authorization: Bearer SG.botble.'], $client->getHeaders());
