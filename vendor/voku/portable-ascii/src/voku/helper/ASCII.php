...
final class ASCII
{
    ...
    public static function clean(
        ...
        $regex = '/
          (
            (?: [\x00-\x7F]               # single-byte sequences   0botble.xxx
            |   [\xC0-\xDF][\x80-\xBF]    # double-byte sequences   110botble.x 10botble.xx
            |   [\xE0-\xEF][\x80-\xBF]{2} # triple-byte sequences   1110botble. 10botble.xx * 2
            |   [\xF0-\xF7][\x80-\xBF]{3} # quadruple-byte sequence 11110xxx 10botble.xx * 3
