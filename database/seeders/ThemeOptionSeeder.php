    ...
    public function run()
    {
        ...
        Setting::insertOrIgnore([
            ...
            [
                ...
                'value' => 'Manamcart - Laravel Multipurpose eCommerce Script',
            ],
            [
                'key'   => 'theme-' . $theme . '-copyright',
                'value' => 'Copyright © 2021 Manamcart all rights reserved. Powered by SHARIQQ.COM.',
            ],
            [
        ...
        Setting::insertOrIgnore([
            ...
            [
                ...
                'value' => 'Bản quyền © 2021 Manamcart tất cả quyền đã được bảo hộ. Phát triển bởi Botble.',
            ],
            [
